...
#define SERVO_PIN 8
#define BUTTON_PIN 3
#define COUNTDOWN_TIME 300000  // 300 seconds in milliseconds for testing
...
void loop() {
  ...
  display.print("CatFeed-1 Open in 8H ");
  display.setCursor(0, 20);
  display.print("CatFeed-2 Open in 16H");
  display.setCursor(0, 30);
  display.print("CatFeed-3 Open in 24H");
  display.setCursor(0, 40);
  display.print("CatFeed-4 Open in 32H");
