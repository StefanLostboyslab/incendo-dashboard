...
import { LayoutDashboard, Activity, Settings, Lightbulb } from 'lucide-react';
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-tron-bg text-tron-text selection:bg-tron-cyan selection:text-black">
            ...
            <main className="flex-1 relative overflow-hidden flex flex-col">
                ...
                <header className="relative z-50 h-16 border-b border-tron-border bg-black/20 backdrop-blur-md flex items-center justify-between px-8">
